                    ...
                    <div className='lg:w-96 p-7'>
                        <form onSubmit={handleSubmit(handleLogin)}>
                            ...
                            <div className="form-control w-full max-w-xs">
                                ...
                                <input type="password" {...register("password", { required: "Password is required", minLength: { value: 2, message: 'Password must be 6 characters or longer' } })} className="input input-bordered w-full max-w-xs" />
                                <label className="label">
